...
COPY packages/playit-service-manager/Cargo.toml packages/playit-service-manager/Cargo.toml
...
RUN touch packages/playit-cli/src/lib.rs && touch packages/playit-ipc/src/lib.rs && touch packages/playit-service-manager/src/lib.rs && touch packages/playitd/src/lib.rs && touch packages/playitd-tray/src/main.rs && touch packages/playitd-windows-setup/src/main.rs && touch packages/agent_core/src/lib.rs && touch packages/agent_proto/src/lib.rs && touch packages/api_client/src/lib.rs
RUN cargo fetch
...
COPY packages/playit-service-manager packages/playit-service-manager
