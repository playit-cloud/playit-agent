    ...
    match action {
        CliAction::Version => {
            ...
            println!(
                ...
                agent_version.version_major,
                agent_version.version_minor,
                agent_version.version_patch,
                agent_version.variant_id,
            );
            println!(
                "Code Version: {}.{}.{} (variant: {})",
                CURRENT_AGENT_VERSION.version_major,
                CURRENT_AGENT_VERSION.version_minor,
                CURRENT_AGENT_VERSION.version_patch,
